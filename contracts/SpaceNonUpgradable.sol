...
contract Space is ISpace, Ownable, IVotes {
    ...
    constructor(string memory uri_, string memory name_, address soulboundContract) {
    ...
    function uri(uint256 attributeId) public view override returns (string memory) {
        return string(abi.encodePacked(_uri, Strings.toString(attributeId), _uriSuffix));
    }
